...
install_requires = [
    ...
    "packaging>=20.0",
    "tensorboard",
    # GPU kernels (flash-attn excluded — needs --no-build-isolation)
    "liger-kernel",
    # Math reward evaluation
    "math-verify",
...
setup(
    ...
    url="https://github.com/furiosa-ai/EfficientRollout",
    license="Apache 2.0",
    author="FuriosaAI",
    description="EfficientRollout: System-Aware Self-Speculative Decoding for RL Rollouts",
