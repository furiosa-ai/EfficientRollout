...
class Worker(WorkerBase):
    ...
    def set_current_gamma(self, gamma: int) -> None:
        """Adaptive-γ SD: update γ on this worker's model runner.

        Called via collective_rpc from EngineCore.wake_up() on elevation.
        Requires γ ∈ gamma_ladder (pre-captured CUDA graphs).
        """
        self.model_runner.set_current_gamma(gamma)
