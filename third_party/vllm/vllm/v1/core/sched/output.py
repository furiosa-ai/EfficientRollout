...
class SchedulerOutput:
    ...
    # Whether speculative decoding is currently enabled (toggle state).
    # Defaults to True so existing non-toggle codepaths are unaffected.
    spec_decode_enabled: bool = True
